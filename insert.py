...
while True:
    ...
    try:
        ...
        sql_insert_product = 'INSERT INTO `' + tableName + '` (`id`, `product_name`, `price`, `currency`, `brand`, `original_site`, `category`) VALUES (%s, %s, %s, %s, %s, %s, %s);'
        ...
        for i in range(len(jsonObj['response']['docs'])):
            ...
            cursor.execute(sql_insert_product, (product_id, product_name, price, currency, brand, original_site, category))
