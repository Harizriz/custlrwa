...
while True:
    ...
    try:
        ...
        sql_insert_product = 'INSERT INTO `' + tableName + '` (`id`, `product_name`, `price`, `currency`, `brand`, `original_site`, `category`, `image_url`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s);'
