...
class ProductPage(models.Model):
    product_name = models.OneToOneField(ScrapedResult, on_delete=models.DO_NOTHING, null = True)
...
class ImageUrl(models.Model):
    product_id = models.ForeignKey(ProductPage, on_delete=models.DO_NOTHING, null = True)
