...
class ScrapedResult(models.Model):
    ...
    original_site = models.TextField(null=True, unique=True)
...
class Reviews(models.Model):
    product = models.ForeignKey(ScrapedResult, on_delete=models.DO_NOTHING, null = True, to_field='original_site')
